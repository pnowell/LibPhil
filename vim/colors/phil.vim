...
" Search
hi IncSearch       ctermfg=NONE ctermbg=NONE gui=NONE guifg=#ffffff guibg=#bb4530
hi Search          ctermfg=NONE ctermbg=NONE gui=NONE guifg=#ffffff guibg=#656530
...
" Cursor
hi Cursor       ctermfg=NONE ctermbg=NONE gui=NONE guifg=#ffffff guibg=#afafaf
hi lCursor      ctermfg=NONE ctermbg=NONE gui=NONE guifg=#ffffff guibg=#afafaf
hi CursorIM     ctermfg=NONE ctermbg=NONE gui=NONE guifg=#ffffff guibg=#afafaf
...
" Syntax group
hi Comment         ctermfg=NONE ctermbg=NONE gui=BOLD guifg=#606060 guibg=NONE
hi Constant        ctermfg=NONE ctermbg=NONE gui=NONE guifg=#d1bfb1 guibg=NONE
hi Error           ctermfg=NONE ctermbg=NONE gui=NONE guifg=#00ffff guibg=NONE
hi Identifier      ctermfg=NONE ctermbg=NONE gui=NONE guifg=#aaaabf guibg=NONE
...
hi PastBounds	   ctermfg=NONE ctermbg=NONE gui=BOLD guifg=#070707 guibg=#cfcfbf
hi String          ctermfg=NONE ctermbg=NONE gui=NONE guifg=#aaaabf guibg=NONE
